...
public class PersonRepository extends DinaRepositoryV2<PersonDto, Person> {
  ...
  protected Link generateLinkToResource(PersonDto dto) {
    try {
      return linkTo(methodOn(PersonRepository.class).onFindOne(dto.getUuid(), null)).withSelfRel();
