...
public class AgentPermissionCheckRepository extends PermissionCheckRepository {

  public AgentPermissionCheckRepository(List<DinaRepositoryV2<?, ?>> dinaRepositories) {
